...
function setModel(model) {
  currentModel = model;
  localStorage.setItem(`readcoachai_model_${currentProvider}`, model);
}
...
function applyTheme() {
  ...
  localStorage.setItem('readcoachai_theme', themeMode);
  localStorage.setItem('readcoachai_color', themeColor);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  themeMode = localStorage.getItem('readcoachai_theme') || 'dark';
  themeColor = localStorage.getItem('readcoachai_color') || 'blue';
  applyTheme();
